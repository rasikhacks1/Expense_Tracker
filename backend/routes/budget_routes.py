...
def budget_alerts(month: Optional[str] = Query(None, description="YYYY-MM")):
    return compute_alerts(month)


@router.get("/check", summary="Check if any budget exists for a given month")
def check_budget_for_month(
